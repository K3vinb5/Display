...
local function updateGui()
        ...
        gui.gui.fuel_level.text.text = "Fuel: " .. tostring(message[4])
        gui.gui.progressbar.progress_bar_0.value = message[5]
        gui.gui.progress_level.text.text = "Progress: " .. tostring(message[5])
    os.sleep(0.5)
end
...
new_button("button_2", 18, 6, 8, 3, colors.yellow, "<\nPrevious", previousChannel)
new_button("button_3", 18, 2, 8, 3, colors.yellow, ">\nNext", nextChannel)
-- Texts:
