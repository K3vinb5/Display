...
shell.run("wget https://raw.githubusercontent.com/K3vinb5/Display/main/main/portableDisplay.lua")
shell.run("cd ..")
shell.run("wget https://raw.githubusercontent.com/K3vinb5/Display/main/install/startupPortable.lua startup.lua")
